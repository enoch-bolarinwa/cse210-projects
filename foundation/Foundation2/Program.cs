    ...
    {        static void Main(string[] args)
        {
            ...
            var product1 = new Product("Fridge", "FRG321", 800m, 3);
            var product2 = new Product("Radio", "RAD546", 50m, 4);
            var product3 = new Product("Iphone", "IP987", 10m, 2);

            var product4 = new Product("Nokia", "NK436", 120m, 5);
            var product5 = new Product("Samsung", "SG967", 100m, 3);
